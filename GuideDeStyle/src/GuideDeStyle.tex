...
\begin{enumerate}
    ...
    \kw{documentclass}, pas de préambule dans ce fichier.
    \item Un fichier, incluant le premier, qui donne le préambule, le titre,
    etc.
\end{enumerate}	

De plus, le niveau maximum de titre dans un document qui est susceptible d'être
inclus est \kw{section}, ce qui permet d'utiliser \kw{part} pour délimiter les
...
défauts qu'avait la fonte d'origine. Le fichier, sous format \kw{ttf} est
disponible dans le dossier \kw{common}, et s'appelle \kw{FreeSans.ttf}.
